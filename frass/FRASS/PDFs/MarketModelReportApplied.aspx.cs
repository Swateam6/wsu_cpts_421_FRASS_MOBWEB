...
{
	public partial class MarketModelReportApplied : System.Web.UI.Page
	{
		User thisUser;
		string fileName = "";
		...
		{
			var PortfolioID = Convert.ToInt32(Request.QueryString["MarketModelPortfolioID"].ToString());
			var RPAPortfolioID = Convert.ToInt32(Request.QueryString["RPAPortfolioID"].ToString());
			var report = new MarketModelSettingsReport(thisUser, PortfolioID, RPAPortfolioID);
			fileName = "MarketModelPortfolio_" + report.MarketModelPortfolio.PortfolioName.Replace(" ", "_") + "_" + report.RPAPortfolio.PortfolioName.Replace(" ", "_");
