...
namespace FRASS.WebUI.PDFs
{
	public partial class MarketValueReport : System.Web.UI.Page
	{
		...
		private MemoryStream GetReport()
		{
			...
			var report = new FRASS.Reports.MarketValueReport(thisUser, db.GetParcel(parcelID), dbPortfolio.GetMarketModelPortfolio(portfolioID), dbRPA.GetRPAPortfolio(rpaPortfolioID), db.GetCurrentParcelTimberSummary(parcelID, System.DateTime.Now.Year), timberstats, baseFilePath);
