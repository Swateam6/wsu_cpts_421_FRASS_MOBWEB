...
namespace FRASS.WebUI.PDFs
{
	public partial class Report : System.Web.UI.Page
	{
		...
		private MemoryStream GetReport()
		{
			...
			var report = new ParcelReport(thisUser, db.GetParcel(parcelID), db.GetCurrentParcelTimberSummary(parcelID, System.DateTime.Now.Year), baseFilePath);
			fileName = "Parcel_" + report.Parcel.ParcelNumber;
