...
{
	public partial class MarketModelAllotments : System.Web.UI.Page
	{
		User thisUser;
		string fileName = "";
		...
		private MemoryStream GetReport()
		{
			...
			var portfolio = dbM.GetMarketModelPortfolio(portfolioid);
			var rpaPortfolio = dbRPA.GetRPAPortfolio(rpaPortfolioID);
			var report = new AllotmentReport(thisUser, db.GetParcel(parcelID), portfolio, rpaPortfolio, timberStats);
